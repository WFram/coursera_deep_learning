...
def gradient_check_n_test_case() -> Tuple[np.ndarray, np.ndarray, Dict[str, Union[str, np.ndarray]]]: 
    np.random.seed(1)
...
def compute_cost_with_regularization_test_case() -> Tuple[np.ndarray, np.ndarray, Dict[str, np.ndarray]]:
    np.random.seed(1)
...
def backward_propagation_with_regularization_test_case() -> Tuple[np.ndarray, np.ndarray, np.ndarray]:
    np.random.seed(1)
...
def forward_propagation_with_dropout_test_case() -> Tuple[np.ndarray, Dict[str, np.ndarray]]:
    np.random.seed(1)
    X_assess = np.random.randn(3, 5)
    W1 = np.random.randn(2, 3)
    b1 = np.random.randn(2, 1)
...
def backward_propagation_with_dropout_test_case() -> Tuple[np.ndarray, np.ndarray, np.ndarray]:
    np.random.seed(1)
    X_assess = np.random.randn(3, 5)
    Y_assess = np.array([[1, 1, 0, 1, 0]])
    cache = (np.array([[-1.52855314,  3.32524635,  2.13994541,  2.60700654, -0.75942115],
